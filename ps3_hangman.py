...
def getGuessedWord(secretWord, lettersGuessed):
    ...
    # FILL IN YOUR CODE HERE...
    ans=''
    for letter in enumerate(secretWord):
        if letter[1] in lettersGuessed:
            ans+=letter[1]
        else:
            ans+="_ "
    return ans
...
Available letters: abcdefghijklmnopqrstuvwxyz""")
    ...
    while i<=8:
        ...
        if guessInLowerCase in m:
            ...
            j-=1
            if j==0:
                print("Sorry, you ran out of guesses. The word was",secretWord.capitalize())
                return
            i+=1
        print("You have ",j,"  guesses left.")
        print("Available letters: ",getAvailableLetters(m))
